 ...
 *
 * One deliberate deviation from the prototype: the status bar sits *above* the
 * app's header gradient. In the prototype the header (z-30) painted over the
 * status bar (z-10), hiding the clock behind a 96%-opaque scrim — clearly
 * unintended, since the header reserves exactly 58px of top padding for it.
 */
...
export function IOSDevice({
  ...
  return (
    ...
    >
      ...
      {/* status bar — above the app header scrim (see file header note) */}
